...
IF(NOT CMAKE_Pasm_COMPILER_WORKS)
  FILE(WRITE ${CMAKE_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/CMakeTmp/testPasmCompiler.p
    "HALT\n")
	TRY_COMPILE(COMPILER_WORKS ${CMAKE_BINARY_DIR} ${CMAKE_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/CMakeTmp/testPasmCompiler.p
    COMPILE_DEFINITIONS "-V3 -y -CPasmCode testPasmCompiler.p"
	  OUTPUT_VARIABLE OUTPUT
    )
  #SET(CMAKE_Pasm_COMPILER_WORKS ${COMPILER_WORKS})
  SET(CMAKE_Pasm_COMPILER_WORKS TRUE)
