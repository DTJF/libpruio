...
rate. When the counter reaches certain values, the state of the output
gets changed. Since PWM output can get generated by different
subsystems (and libpruio support many of them), the resolution and the
frequency range vary between the pins.

| Pin   | Subsystem      | Frequency Range    |
| ----- | :------------: | :----------------- |
| P8_07 | TIMER-4        | 0.00000??? to 50e6 Hz |
| P8_08 | TIMER-7        | 0.00000??? to 50e6 Hz |
| P8_09 | TIMER-5        | 0.00000??? to 50e6 Hz |
| P8_10 | TIMER-6        | 0.00000??? to 50e6 Hz |
