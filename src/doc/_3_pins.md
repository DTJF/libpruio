...
for the `Dur2` period. Both periods are specified directly in [mSec]
(instead of setting frequency and duty cycle). Additionally a TIMER can
operate in one shot mode, stopping after the first sequence.
...
the duration range in [mSec] vary between the pins. In any case the
counter resolution is 32 bit.

|  BB   |  PB   | Subsystem       | Max Dur  |   Min Dur | Notice            |
| ----: | :---- | :-------------: | :------- | :-------: | :---------------- |
| P8_07 |       | TIMER-4         | 45812000 | 0.000167  | free              |
| P8_09 | P1_28 | TIMER-5         | 45812000 | 0.000167  | free              |
| P8_10 | P1_26 | TIMER-6         | 45812000 | 0.000167  | free              |
| P8_08 | P2_28 | TIMER-7         | 45812000 | 0.000167  | free              |
| P9_42 |       | PWMSS-0, CAP    |  4294000 | 0.00002   | free (double pin) |
| SD_10 | SD_10 | PWMSS-1, CAP    |  4294000 | 0.00002   | uSD slot          |
| JT_05 |       | PWMSS-1, CAP    |  4294000 | 0.00002   | JTag (UART0_TXD)  |
| P9_28 | P2_30 | PWMSS-2, CAP    |  4294000 | 0.00002   | MCASP0            |
